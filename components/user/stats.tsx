...
const StatsCard = ({ imgURL, value, title }: StatsCardProps) => (
  <div className="light-border background-light900_dark300 flex flex-wrap items-center justify-sta gap-4 rounded-md border p-6 shadow-light-300 dark:shadow-dark-200">
  ...
  return (
    <div className="mt-3">
      ...
      <div className="mt-5 grid grid-cols-1 gap-5 xs:grid-cols-2 md:grid-cols-4">
        ...
        <StatsCard imgURL={goldBadge} value={badges.GOLD} title="Gold Badges" />
        <StatsCard
          imgURL={silverBadge}
          value={badges.SILVER}
          title="Silver Badges"
